...
hw_interface_plugin_old_roboteq::roboteq_serial::roboteq_serial()
{
...
bool hw_interface_plugin_old_roboteq::roboteq_serial::subPluginInit(ros::NodeHandlePtr nhPtr)
{
...
void hw_interface_plugin_old_roboteq::roboteq_serial::setInterfaceOptions()
{
	int tempBaudRate = 0;
...
bool hw_interface_plugin_old_roboteq::roboteq_serial::interfaceReadHandler(const long &length,
                                                                            int arrayStartPos)
{
...
bool hw_interface_plugin_old_roboteq::roboteq_serial::verifyChecksum()
{
    return true;
}
...
hw_interface_plugin_old_roboteq::roboteq_serial::matchFooter(matcherIterator begin, matcherIterator end, const char* sequence)
{
    int i = 0;
